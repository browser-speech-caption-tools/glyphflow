...
The package import includes the default CSS. Override `--kn-highlight-color`,
`--kn-unhighlight-color`, font, size, and spacing in an application stylesheet
that you import after GlyphFlow.
